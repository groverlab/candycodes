...
class candycode:
    ...
    def triangulate(self):
        ...
        for center in self.candies:
            ...
            order = {"R":5, "P":4, "O":3, "Y":7, "G":1, "L":2, "D":0, "W":6,
                     "1":8, "2":9, "3":10, "4":11, "5":12, "6":13, "7":14}  # alpha plus extra colors
...
for i in range(runs):
    ...
    while len(xs) < 94:   # This is the target number of candies per candycode; was 80
        ...
        if keep:
            ...
            colors.append(random.choice("RPOYGLDW1234567")) # unbiased plus extra colors
